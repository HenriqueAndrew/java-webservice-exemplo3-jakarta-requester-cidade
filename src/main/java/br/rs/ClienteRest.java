...
public class ClienteRest {
    ...
    public void merge(Object requestEntity) throws ClientErrorException {
        webTarget.path("merge").request(javax.ws.rs.core.MediaType.APPLICATION_JSON).put(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_JSON));
    }
